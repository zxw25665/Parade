...
const (
	...
	FileTransferService_BrowseDirectory_FullMethodName = "/parade.file.v1.FileTransferService/BrowseDirectory"
)
...
type FileTransferServiceClient interface {
	...
	BrowseDirectory(ctx context.Context, in *BrowseRequest, opts ...grpc.CallOption) (*BrowseResponse, error)
}
...
func (c *fileTransferServiceClient) BrowseDirectory(ctx context.Context, in *BrowseRequest, opts ...grpc.CallOption) (*BrowseResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(BrowseResponse)
	err := c.cc.Invoke(ctx, FileTransferService_BrowseDirectory_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type FileTransferServiceServer interface {
	...
	BrowseDirectory(context.Context, *BrowseRequest) (*BrowseResponse, error)
...
func (UnimplementedFileTransferServiceServer) BrowseDirectory(context.Context, *BrowseRequest) (*BrowseResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method BrowseDirectory not implemented")
}
...
func _FileTransferService_BrowseDirectory_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(BrowseRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(FileTransferServiceServer).BrowseDirectory(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: FileTransferService_BrowseDirectory_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FileTransferServiceServer).BrowseDirectory(ctx, req.(*BrowseRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var FileTransferService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "BrowseDirectory",
			Handler:    _FileTransferService_BrowseDirectory_Handler,
		},
	},
